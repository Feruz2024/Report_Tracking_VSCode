...
function ActiveStationList({ refresh }) {
  ...
  // Only show stations that are active
  ...
  return (
    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24, marginTop: 16, justifyContent: 'center' }}>
      {activeStations.length === 0 && <div style={{ color: '#888', fontStyle: 'italic' }}>No active stations found.</div>}
...
export default ActiveStationList;
